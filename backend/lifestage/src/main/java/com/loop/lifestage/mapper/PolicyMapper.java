...
public interface PolicyMapper {
  ...
  @Mapping(source = "coveredLifeEvents", target = "coveredLifeEvents", qualifiedByName = "lifeEventsToIds")
  PolicyDTO toPolicyDTO(Policy policy);

  @Mapping(source = "coveredLifeEvents", target = "coveredLifeEvents", qualifiedByName = "idsToLifeEvents")
